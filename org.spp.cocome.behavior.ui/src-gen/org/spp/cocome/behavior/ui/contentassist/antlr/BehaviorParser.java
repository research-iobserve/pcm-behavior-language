		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getQueryElementAccess().getAlternatives(), "rule__QueryElement__Alternatives");
					...
					put(grammarAccess.getQueryExpressionAccess().getGroup_1(), "rule__QueryExpression__Group_1__0");
					...
					put(grammarAccess.getQueryExpressionAccess().getLeftAssignment_0(), "rule__QueryExpression__LeftAssignment_0");
					put(grammarAccess.getQueryExpressionAccess().getRightAssignment_1_1(), "rule__QueryExpression__RightAssignment_1_1");
					put(grammarAccess.getTypedValueReferenceAccess().getTypedValueAssignment(), "rule__TypedValueReference__TypedValueAssignment");
