...
// Entry rule entryRuleTypedValueReference
entryRuleTypedValueReference 
:
...
{ before(grammarAccess.getDataQueryAccess().getQueryQueryExpressionParserRuleCall_2_0()); }
	ruleQueryExpression{ after(grammarAccess.getDataQueryAccess().getQueryQueryExpressionParserRuleCall_2_0()); }
)
...
{ before(grammarAccess.getQueryExpressionAccess().getLeftQueryElementParserRuleCall_0_0()); }
	ruleQueryElement{ after(grammarAccess.getQueryExpressionAccess().getLeftQueryElementParserRuleCall_0_0()); }
)
...
{ before(grammarAccess.getQueryExpressionAccess().getRightQueryExpressionParserRuleCall_1_1_0()); }
	ruleQueryExpression{ after(grammarAccess.getQueryExpressionAccess().getRightQueryExpressionParserRuleCall_1_1_0()); }
)
...
{ before(grammarAccess.getTypedValueReferenceAccess().getTypedValueTypedValueIDTerminalRuleCall_0_1()); }
	RULE_ID{ after(grammarAccess.getTypedValueReferenceAccess().getTypedValueTypedValueIDTerminalRuleCall_0_1()); }
)
