...
public class BehaviorSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     property=[Property|ID] (ambiguity) '.' subProperty=PropertyCall
	 *     property=[Property|ID] (ambiguity) (rule end)
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     variable=[VariableDecl|ID] (ambiguity) '.' subProperty=PropertyCall
	 *     variable=[VariableDecl|ID] (ambiguity) (rule end)
	 */
