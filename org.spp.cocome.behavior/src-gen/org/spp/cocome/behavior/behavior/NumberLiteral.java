...
public interface NumberLiteral extends Literal
{
   ...
   * @see #setValue(String)
   * @see org.spp.cocome.behavior.behavior.BehaviorPackage#getNumberLiteral_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link org.spp.cocome.behavior.behavior.NumberLiteral#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
