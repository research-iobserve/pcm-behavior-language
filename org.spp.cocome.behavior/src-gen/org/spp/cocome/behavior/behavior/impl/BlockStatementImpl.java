...
public class BlockStatementImpl extends MinimalEObjectImpl.Container implements BlockStatement
{
  ...
  {
    return BehaviorPackage.Literals.BLOCK_STATEMENT;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, BehaviorPackage.BLOCK_STATEMENT__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BehaviorPackage.BLOCK_STATEMENT__STATEMENTS:
