...
public interface StringLiteral extends QueryElement, Literal
{
   ...
   * @see #setValue(String)
   * @see org.spp.cocome.behavior.behavior.BehaviorPackage#getStringLiteral_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link org.spp.cocome.behavior.behavior.StringLiteral#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
