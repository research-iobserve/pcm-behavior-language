...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Data Access Operation</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.spp.cocome.behavior.behavior.BehaviorPackage#getDataAccessOperation()
 * @model
 * @generated
 */
public enum DataAccessOperation implements Enumerator
{
  /**
  ...
  /**
   * An array of all the '<em><b>Data Access Operation</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final DataAccessOperation[] VALUES_ARRAY =
    new DataAccessOperation[]
    {
      STORE,
      UPDATE,
      DELETE,
  ...
  /**
   * A public read-only list of all the '<em><b>Data Access Operation</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<DataAccessOperation> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
  ...
  public static DataAccessOperation get(String literal)
  {
    ...
    {
      DataAccessOperation result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  private DataAccessOperation(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
