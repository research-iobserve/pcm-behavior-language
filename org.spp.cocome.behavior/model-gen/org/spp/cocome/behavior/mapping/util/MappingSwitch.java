...
public class MappingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MappingPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MappingPackage.INTERFACE: {
			...
			case MappingPackage.METHOD_DECL: {
				MethodDecl methodDecl = (MethodDecl)theEObject;
				T result = caseMethodDecl(methodDecl);
				if (result == null) result = caseNamedElement(methodDecl);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MappingPackage.PARAMETER: {
				...
				if (result == null) result = caseTypedValue(parameter);
				if (result == null) result = caseNamedElement(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MappingPackage.TYPED_VALUE: {
				TypedValue typedValue = (TypedValue)theEObject;
				T result = caseTypedValue(typedValue);
				if (result == null) result = caseNamedElement(typedValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
